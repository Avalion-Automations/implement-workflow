  ...
  return (
    <main className="shell">
      ...
      <section className="kpis" aria-label="Workflow summary">
        <Metric label="Task completion" value={`${completion.complete}/${completion.total}`} detail={`${completion.taskPercent}% of recorded tasks`} />
        <Metric label="Milestone progress" value={`${completion.milestonePercent}%`} detail="weighted workflow milestones" />
