...
export function checkSkill(input) {
  ...
  const metadata = join(root, "agents", "host-ui-metadata.yaml"); if (!existsSync(metadata)) add("warning", "ui-metadata", "agents/host-ui-metadata.yaml is absent; create it for skill discovery UI.");
  return findings;
}
